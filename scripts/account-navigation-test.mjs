...
assert.deepEqual(hrefs(accountSections(member)), [
  '/me',
  '/squads',
  '/account',
  '/account/security',
])
assert.deepEqual(hrefs(accountHeaderLinks(member)), [
  '/me',
  '/squads',
  '/account',
  '/account/security',
...
assert.deepEqual(hrefs(accountSections(staff)), [
  '/me',
  '/squads',
  '/account',
  '/account/security',
...
assert.deepEqual(
  ...
  ['/me', '/squads', '/account', '/account/security', '/admin'],
